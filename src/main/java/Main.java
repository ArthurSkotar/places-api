...
public class Main {
    ...
    public static void main(String[] args) throws InterruptedException, ApiException, IOException {
        ...
        final Place place = ResponseToPlaceMapper.mapResponseToPlace(resource.listPlacesByTypeAndLocation(PlaceType.MUSEUM, location, 1).get(0));
        final PlaceDao dao = new PlaceDaoImpl();
        dao.createPlace(place);
    }
}
